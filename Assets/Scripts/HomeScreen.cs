...
{
    private const string MaxSdkKey = "zOn5A1bK1ldnz7ZyZ1Cv7uoMZd_wG_h8Is4QVmQ6VhwFKAClv9HpK53Vf4eTrFTtybGESzxqU2K1w83rVmmJll";
...
#else // UNITY_ANDROID
    private const string InterstitialAdUnitId = "c0007e4a16490187";
    private const string RewardedAdUnitId = "76a3c3958c643f5e";
    private const string RewardedInterstitialAdUnitId = "ENTER_ANDROID_REWARD_INTER_AD_UNIT_ID_HERE";
    private const string BannerAdUnitId = "682dd7006178d7d3";
    ...
    void Start()
    {
        ...
        MaxSdk.SetUserId("Moloco_Publisher_AppLovin_Unity_Demo");
